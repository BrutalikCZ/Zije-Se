export const getQuestions = (lang: 'cs' | 'en'): string[] => {
    const cs = [
        ...
        "Je pro vás klíčové, aby se ve vašem okolí nenacházely velké průmyslové zóny nebo továrny? (Většina mapy bude vyřazena) ",
        ...
        "Chcete se vyhnout bydlení v blízkosti věznice?",
