                ...
                >
                    ...
                    {aiPoiData && (
                        <MapCircleLayer
                            ...
                            data={aiPoiData}
                            autoFlyTo={true}
                            color={`expression:${JSON.stringify([
                                'match',
                                ['get', '_category'],
                                'preschool', '#f06292',
                                'school', '#1e88e5',
                                'primary_school', '#1e88e5',
                                'secondary_school', '#1976d2',
                                'university', '#3949ab',
                                'hospital', '#e53935',
                                'doctor', '#ff7043',
                                'dentist', '#ff5722',
                                ...
                                'playground', '#ffb300',
                                'supermarket', '#00acc1',
                                'convenience_store', '#0097a7',
                                'mall', '#00838f',
                                'train_station', '#546e7a',
                                'bus_station', '#455a64',
                                'transit_station', '#37474f',
                                'airport', '#263238',
                                'bank', '#fdd835',
                                'atm', '#ffeb3b',
                                'post_office', '#3f51b5',
                            ...
                            outlineColor={`expression:${JSON.stringify([
                                'match',
                                ['get', '_category'],
                                'preschool', '#c2185b',
                                'school', '#1565c0',
                                'primary_school', '#1565c0',
                                'secondary_school', '#124191',
                                'university', '#283593',
                                'hospital', '#c62828',
                                'doctor', '#d84315',
                                'dentist', '#bf360c',
                                ...
                                'playground', '#ff8f00',
                                'supermarket', '#00838f',
                                'convenience_store', '#006064',
                                'mall', '#004d40',
                                'train_station', '#37474f',
                                'bus_station', '#263238',
                                'transit_station', '#1c252b',
                                'airport', '#12191d',
                                'bank', '#fbc02d',
                                'atm', '#f9a825',
                                'post_office', '#303f9f',
